...
<div className="max-w-screen-xl lg:mx-auto mx-4 my-4 ">
 ...
 <div className="max-w-screen-xl lg:mx-auto mx-4 my-8 bg-green-50 rounded-xl p-6 shadow-md">
  <div className="w-full p-4 rounded-lg">
    <h3 className="text-center text-xl md:text-2xl font-bold text-green-700 mb-6">
      ডাউনলোড ই-বিএনপি
    </h3>
    <div className="flex  justify-center gap-4 max-w-md mx-auto">
      ...
      >
        ...
        <div className="flex flex-col items-start">
          <span className="text-sm md:text-base">IOS</span>
          <span className="text-sm md:text-base font-medium">App</span>
        </div>
      </button>
      <a
        href="https://bnpctg.com/uploads/apk/E-BNP.apk" 
        download="BnpCtg.apk" 
      ...
      >
        ...
        <div className="flex flex-col items-start">
          <span className="text-sm md:text-base font-medium">Android</span>
          <span className="text-sm md:text-base font-medium">App</span>
        </div>
      </a>
    </div>
